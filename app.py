...
def extract_data_with_template(_llm, text: str, report_type: str) -> list | None:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
         ...
         "\n2. Для каждой СТАНДАРТНОЙ статьи из предоставленного списка в соответствии с IFRS определи одну или несколько СООТВЕТСТВУЮЩИХ статей в исходном тексте из загруженного отчета."
